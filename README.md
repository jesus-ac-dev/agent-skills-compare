...
- **Next.js 15** — UI para consulta e filtragem dos dados
...
### 3. Pipeline (Backend)
Para pesquisar e analisar repositórios:
```bash
...
- `src/`: Pipeline de extração e análise.
- `web/`: Aplicação Next.js para visualização dos dados.
